    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="text-muted">Apply for leave and track your applications</p>
        </div>
            ...
            <div className="modal-body" style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div className="form-group">
                ...
                <select className="form-input" value={form.leave_type} onChange={e => setForm(f => ({ ...f, leave_type: e.target.value }))}>
                  {['Sick', 'Casual', 'Emergency', 'Personal'].map(t => <option key={t}>{t}</option>)}
                </select>
              </div>
              ...
              <div className="form-group">
                <label>Reason</label>
                <textarea className="form-input" rows={3} placeholder="Describe your reason for leave…"
